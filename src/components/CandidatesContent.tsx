              ...
              <tr key={candidate.id} className="hover:bg-slate-50/50 transition-colors">
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <img className="h-12 w-12 rounded-xl object-cover ring-2 ring-white shadow-sm" src={candidate.avatar || 'https://picsum.photos/seed/avatar/48/48'} alt={candidate.name} referrerPolicy="no-referrer" />
                    <div className="ml-4">
